...
const ProjectMarketingGroups: React.FC = () => {
  ...
  }, [currentProject?.id]); // Only depend on the project ID, not the entire project object
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-xl font-semibold text-brand-text">Marketing Groups</h2>
          <p className="text-sm text-gray-400 mt-1">
            Manage marketing groups for this project. Each group can contain templates and copy.
          </p>
        </div>
        <button
...
export default ProjectMarketingGroups; 